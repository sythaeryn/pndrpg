...
//		PatchObject			PO;
		...
		NLMAXCONSTCHAR *GetObjectName() { return TEXT("Rykol Patch Object");}
		...
		void InitNodeName(TSTR& s) { s = TEXT("Rykol Patch Object"); }
...
#define copyFlags(dest, source, mask) dest =  ((dest&(~mask))|(source&mask))
		...
		void GetClassName(TSTR& s) {s = TEXT("Rykol Patch Object");}
