...
{block name=content}
		...
		<div class="navbar-inner">
			<div class="container">
				...
				<div class="btn-group pull-right">
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<span class="glyphicon glyphicon-user"></span><span class="hidden-phone"> admin</span>
						<span class="caret"></span>
					</a>
	...
	<!-- topbar ends -->
		...
		<div class="row">
			...
			<!-- left menu starts -->
			<div class="col-md-2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li class="nav-header hidden-tablet">Main</li>
						<li style="margin-left: -2px;" class="active"><a class="ajax-link" href="?page=home"><span class="glyphicon glyphicon-home"></span><span class="hidden-tablet"> Dashboard</span></a></li>
						<li class="nav-header hidden-tablet">Sample Section</li>
						<li style="margin-left: -2px;"><a href="?page=login"><span class="glyphicon glyphicon-lock"></span><span class="hidden-tablet"> Login Page</span></a></li>
					</ul>
			...
			<div class="sortable row ui-sortable">
				<a data-original-title="6 new members." data-rel="tooltip" class="well col-md-3 top-block" href="#">
				...
				<a data-original-title="4 new pro members." data-rel="tooltip" class="well col-md-3 top-block" href="#">
				...
				<a data-original-title="$34 new sales." data-rel="tooltip" class="well col-md-3 top-block" href="#">
				...
				<a data-original-title="12 new messages." data-rel="tooltip" class="well col-md-3 top-block" href="#">
			...
			<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="glyphicon glyphicon-info-sign"></span> Introduction
					</div>
			...
			<div class="row sortable ui-sortable">
				...
				<div class="panel panel-default">
					<div class="panel-heading" data-original-title="">
						<span class="glyphicon glyphicon-user"></span> Member Activity
						<div class="box-icon">
				...
				<div class="panel panel-default">
					<div class="panel-heading" data-original-title="">
						<span class="glyphicon glyphicon-list-alt"></span> Realtime Traffic
						<div class="box-icon">
							<a href="#" class="btn btn-xsmize btn-round"><span class="glyphicon glyphicon-chevron-up"></span></a>
							<a href="#" class="btn btn-close btn-round"><span class="glyphicon glyphicon-remove"></span></a>
						</div>
			...
			<div class="row sortable ui-sortable">
				...
				<div class="panel panel-default">
					<div class="panel-heading" data-original-title="">
						<span class="glyphicon glyphicon-list"></span> Buttons
						<div class="box-icon">
					...
					<div class="panel-body buttons">
						...
						<p>
							<button class="btn btn-sm"><span class="glyphicon glyphicon-star"></span> Icon button</button>
						...
						<p>
							<button class="btn btn-sm btn-inverse">Small button</button>
							<button class="btn btn-lg btn-primary btn-round">Round button</button>
							<button class="btn btn-lg btn-round"><span class="glyphicon glyphicon-ok"></span></button>
							<button class="btn btn-primary"><span class="glyphicon glyphicon-edit icon-white"></span></button>
						</p>
						<p>
							<button class="btn btn-xs">Mini button</button>
							<button class="btn btn-xs btn-primary">Mini button</button>
							<button class="btn btn-xs btn-danger">Mini button</button>
							<button class="btn btn-xs btn-warning">Mini button</button>
						</p>
						<p>
							<button class="btn btn-xs btn-info">Mini button</button>
							<button class="btn btn-xs btn-success">Mini button</button>
							<button class="btn btn-xs btn-inverse">Mini button</button>
						</p>
					</div>
					</div>
				</div><!--/span-->
				...
				<div class="panel panel-default">
					...
					<div class="panel-body  buttons">
						...
						<p>
							<button class="btn btn-lg btn-danger">Large button</button>
						...
						<p>
							<button class="btn btn-lg btn-inverse">Large button</button>
						</p>
						<div class="btn-group">
							<button class="btn btn-lg">Large Dropdown</button>
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#"><span class="glyphicon glyphicon-tag"></span> Another action</a></li>
								<li><a href="#"><span class="glyphicon glyphicon-download-alt"></span> Something else here</a></li>
								<li class="divider"></li>
								<li><a href="#"><span class="glyphicon glyphicon-tint"></span> Separated link</a></li>
							</ul>
						</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" data-original-title="">
						<span class="glyphicon glyphicon-list"></span> Weekly Stat
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><span class="glyphicon glyphicon-cog"></span></a>
							<a href="#" class="btn btn-xsmize btn-round"><span class="glyphicon glyphicon-chevron-up"></span></a>
							<a href="#" class="btn btn-close btn-round"><span class="glyphicon glyphicon-remove"></span></a>
