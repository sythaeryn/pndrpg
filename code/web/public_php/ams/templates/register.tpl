...
<div class="row">
	<div class="well col-md-5 center login-box">
		...
		<form id="signup" class="form-vertical" method="post" action="index.php">
			...
			<div class="form-group {if isset($USERNAME_ERROR) and $USERNAME_ERROR eq "TRUE"}error{else if
			...
			<div class="form-group {if isset($PASSWORD_ERROR) and $PASSWORD_ERROR eq "TRUE"}error{else if
			isset($PASSWORD) and $PASSWORD eq "success"}success{else}{/if}">
			<label class="control-label">{$password_tag}</label>
				<div class="controls">
				    <div class="input-prepend">
					<span class="add-on"><span class="glyphicon glyphicon-lock"></span></span>
			...
			<div class="form-group {if isset($CPASSWORD_ERROR) and $CPASSWORD_ERROR eq "TRUE"}error{else if
			...
			<div class="form-group {if isset($EMAIL_ERROR) and $EMAIL_ERROR eq "TRUE"}error{else if
			...
			<div class="form-group {if isset($TAC_ERROR) and $TAC_ERROR eq "TRUE"}error{else if
