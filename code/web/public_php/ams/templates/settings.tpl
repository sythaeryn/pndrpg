{block name=content}
	<div class="row js-masonry" data-masonry-options='{ "itemSelector": ".js-masonry-item", "transitionDuration": 0 }'>
			...
			<div class="panel-body">
					<form id="changePassword" class="form-vertical" method="post" action="index.php?page=settings&id={$target_id}">
						...
						{if !isset($changesOther) or $changesOther eq "FALSE"}
							<div class="form-group {if isset($MATCH_ERROR) and $MATCH_ERROR eq "TRUE"}error{else if
				isset($match_error_message) and $match_error_message neq "fail"}success{else}{/if}">
							<label class="control-label">Current Password</label>
								<div class="controls">
								    <div class="input-prepend">
									<span class="add-on" style="margin-left:5px;"><span class="glyphicon glyphicon-lock"></span></span>
						...
						{/if}
							<div class="form-group {if isset($NEWPASSWORD_ERROR) and $NEWPASSWORD_ERROR eq "TRUE"}error{else if
			isset($newpass_error_message) and $newpass_error_message eq "success"}success{else}{/if}">
						<label class="control-label">New Password</label>
							<div class="controls">
							    <div class="input-prepend">
								<span class="add-on" style="margin-left:5px;"><span class="glyphicon glyphicon-tag"></span></span>
						...
						<div class="form-group {if isset($CNEWPASSWORD_ERROR) and $CNEWPASSWORD_ERROR eq "TRUE"}error{else if
			isset($confirmnewpass_error_message) and $confirmnewpass_error_message eq "success"}success{else}{/if}">
						<label class="control-label">Confirm New Password</label>
							<div class="controls">
							    <div class="input-prepend">
								<span class="add-on" style="margin-left:5px;"><span class="glyphicon glyphicon-tags"></span></span>
		...
		<div class="panel panel-default">
			<div class="panel-heading" data-original-title="">
				<span class="glyphicon glyphicon-th"></span> Add User
			</div>
			<div class="panel-body">
					<form id="addUser" class="form-vertical" method="post" action="index.php?page=settings&id={$target_id}">
						<legend>Add User</legend>

						<div class="form-group {if isset($USERNAME_ERROR) and $USERNAME_ERROR eq "TRUE"}error{/if}">
							<label class="control-label">Username</label>
								<div class="controls">
									<div class="input-prepend">
									<span style="margin-left:5px;" class="add-on"><span class="glyphicon glyphicon-user"></span></span>
						...
						<div class="form-group {if isset($PASSWORD_ERROR) and $PASSWORD_ERROR eq "TRUE"}error{/if}">
							<label class="control-label">Password</label>
								<div class="controls">
								    <div class="input-prepend">
										<span style="margin-left:5px;" class="add-on"><span class="glyphicon glyphicon-lock"></span></span>
						...
						<div class="form-group {if isset($CPASSWORD_ERROR) and $CPASSWORD_ERROR eq "TRUE"}error{/if}">
						...
						<div class="form-group {if isset($EMAIL_ERROR) and $EMAIL_ERROR eq "TRUE" and isset($do)}error{/if}">
						<label class="control-label">Email</label>
							<div class="controls">
							    <div class="input-prepend">
								<span style="margin-left:5px;" class="add-on"><span class="glyphicon glyphicon-envelope"></span></span>
		...
		<div class="panel panel-default">
			<div class="panel-heading" data-original-title="">
				<span class="glyphicon glyphicon-th"></span> Change Email
			</div>
			<div class="panel-body">
					<form id="changeEmail" class="form-vertical" method="post" action="index.php?page=settings&id={$target_id}">
						<legend>Change Email</legend>
						<div class="form-group {if isset($CEMAIL_ERROR) and $CEMAIL_ERROR eq "TRUE"}error{/if}">
						<label class="control-label">New Email</label>
							<div class="controls">
							    <div class="input-prepend">
								<span class="add-on" style="margin-left:5px;"><span class="glyphicon glyphicon-envelope"></span></span>
		...
		<div class="panel panel-default">
			<div class="panel-heading" data-original-title="">
				<span class="glyphicon glyphicon-envelope"></span> Ticket updates
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading" data-original-title="">
				<span class="glyphicon glyphicon-th"></span> Change Info
			</div>
			<div class="panel-body">
					<form id="changeEmail" class="form-vertical" method="post" action="index.php?page=settings&id={$target_id}">
