		...
		<table class="table table-striped table-bordered bootstrap-datatable datatable">
			...
			{foreach from=$grouplist item=group}
			  <tr>
				...
				{if isset($isAdmin) && $isAdmin eq 'TRUE'}<td class="center"><a class="btn btn-danger" href="index.php?page=sgroup_list&delete={$group.sGroupId}"><span class="glyphicon glyphicon-trash icon-white"></span> Delete</a></td>{/if}
			  </tr>
			  {/foreach}
