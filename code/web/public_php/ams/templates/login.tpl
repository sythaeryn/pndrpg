		...
		<form method="post" action="index.php{if isset($getstring)}{$getstring}{/if}" class="form-horizontal">
			<fieldset>
				<div data-rel="tooltip" class="input-prepend" data-original-title="Username/Email">
					<span class="add-on"><span class="glyphicon glyphicon-user"></span></span><input type="text" value="" id="LoginValue" name="LoginValue" class="input-large col-md-10" placeholder="Username or Email">
				</div>
