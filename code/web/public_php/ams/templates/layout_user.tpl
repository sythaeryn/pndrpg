...
{block name=menu}
	{if $permission eq 1}
		...
		{if isset($hook_info)} {foreach from=$hook_info key=arrkey item=element}{if isset($element.user_display)}<li style="margin-left: -2px;"><a class="ajax-link" href="index.php?page=layout_plugin&name={$arrkey}"><span class="glyphicon glyphicon-th-list"></span><span class="hidden-tablet"> {$element.user_display}</span></a></li>{/if}{/foreach}{/if} 
		<li class="nav-header hidden-tablet">Actions</li>
		<li style="margin-left: -2px;"><a class="ajax-link" href="index.php?page=createticket"><span class="glyphicon glyphicon-pencil"></span><span class="hidden-tablet">Create New Ticket</span></a></li> 
